...
def process_data(textFile,window_size): <1>
    couples=[]
    labels=[]
...
word_target, word_context = zip(*couples) <2>

input_target = Input((1,)) <3>
...
[CA]steps_per_epoch=100, epochs=epochs) <6>

save_embedding("embedding.txt",
[CA]embedding.get_weights()[0], vocab) <7>
